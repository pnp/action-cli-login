...
describe('validate', () => {
    ...
    it('throws error if TENANT is not passed and env variable CLIMICROSOFT365_TENANT is empty', () => {
        ...
        assert.throws(() => validate(options), Error, 'TENANT is required or the environment variable CLIMICROSOFT365_TENANT must be set with the ID of the tenant you want to authenticate to.');
    });
