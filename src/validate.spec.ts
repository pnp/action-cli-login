...
describe('validate', () => {
    ...
    it('throws error if ADMIN_USERNAME, ADMIN_PASSWORD and CERTIFICATE_ENCODED not passed', () => {
        const options: Options = { ADMIN_USERNAME: '', ADMIN_PASSWORD: '', CERTIFICATE_ENCODED: '', CERTIFICATE_PASSWORD: '', AAD_APP_ID: '', TENANT_ID: '' };
    ...
    it('throws error if ADMIN_USERNAME is passed without ADMIN_PASSWORD', () => {
        const options: Options = { ADMIN_USERNAME: 'adminUsername', ADMIN_PASSWORD: '', CERTIFICATE_ENCODED: '', CERTIFICATE_PASSWORD: '', AAD_APP_ID: '', TENANT_ID: '' };
    ...
    it('throws error if ADMIN_PASSWORD is passed without ADMIN_USERNAME', () => {
        const options: Options = { ADMIN_USERNAME: '', ADMIN_PASSWORD: 'adminPassword', CERTIFICATE_ENCODED: '', CERTIFICATE_PASSWORD: '', AAD_APP_ID: '', TENANT_ID: '' };
    ...
    it('does not throw error when ADMIN_USERNAME and ADMIN_PASSWORD passed', () => {
        const options: Options = { ADMIN_USERNAME: 'adminUsername', ADMIN_PASSWORD: 'adminPassword', CERTIFICATE_ENCODED: '', CERTIFICATE_PASSWORD: '', AAD_APP_ID: '', TENANT_ID: '' };
        assert.doesNotThrow(() => validate(options), Error);
    });

    it('does not throw error when CERTIFICATE_ENCODED passed', () => {
        const options: Options = { ADMIN_USERNAME: '', ADMIN_PASSWORD: '', CERTIFICATE_ENCODED: 'EDDFSFEZRZZER2342RER3423RZER234234R', CERTIFICATE_PASSWORD: '', AAD_APP_ID: '', TENANT_ID: '' };
        assert.doesNotThrow(() => validate(options), Error);
    });
});